const malzemeler=document.createElement("h1");
malzemeler.className="malzemeler";
document.querySelector("body").appendChild(malzemeler);
malzemeler.innerText="Malzeme Listesi";
...
const liste2 =document.createElement("h1");
liste2.className="liste2";
document.querySelector(".Ydiv").appendChild(liste2);
document.querySelector(".liste2").innerHTML="Yeni Liste";

const baslik =document.createElement("p");
baslik.className="baslik";
document.querySelector(".Ydiv").appendChild(baslik);
baslik.innerHTML="yeni baslik";
